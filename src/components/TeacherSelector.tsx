...
export function TeacherSelector() {
  const { teacher, teachers, loading, error, setTeacherId } = useTeacher();

  // Don't show if teacher is already selected or still loading (unless there's an error)
  if (!error && (loading || teacher)) return null;
